          ...
          <div>
              <div className="bg-gradient-to-br from-blue-50/80 to-cyan-100/80 rounded-3xl shadow-xl border-2 border-blue-200/50 overflow-hidden backdrop-blur-sm">
                ...
                <div className="p-8 grid grid-cols-1 md:grid-cols-12 gap-6">
                  ...
                  <InputField width="md:col-span-3" label="বয়স" name="Age" placeholder="যেমন: ১০" icon={Calendar} />
                  <InputField width="md:col-span-3" label="আগ্রহী শ্রেণি" name="Class" placeholder="ভর্তি হতে ইচ্ছুক শ্রেণি" icon={BookOpen} />
                ...
                <div className="p-8 space-y-8">
                  ...
                  <div className="relative p-6 rounded-2xl bg-white/60 border border-blue-200 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-5 mt-2">
                      ...
                      <InputField width="md:col-span-3" label="শিক্ষাগত যোগ্যতা" name="FatherEdu" />
                      <InputField width="md:col-span-2" label="মোবাইল" name="FatherMobile" required placeholder="017xxxxxxxx" icon={Phone} />
                    </div>
                  </div>
                  ...
                  <div className="relative p-6 rounded-2xl bg-white/60 border border-pink-200 shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-5 mt-2">
                      ...
                      <InputField width="md:col-span-3" label="শিক্ষাগত যোগ্যতা" name="MotherEdu" />
                      <InputField width="md:col-span-2" label="মোবাইল" name="MotherMobile" icon={Phone} />
                    </div>
                  </div>
