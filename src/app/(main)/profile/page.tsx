...
const mockAttendance: AttendanceRecord[] = [
  { date: "2025-02-01", status: "present", checkIn: "08:00 AM", checkOut: "02:00 PM" },
  { date: "2025-02-02", status: "present", checkIn: "07:55 AM", checkOut: "02:05 PM" },
  { date: "2025-02-03", status: "late", checkIn: "08:30 AM", checkOut: "02:00 PM" },
  { date: "2025-02-04", status: "present", checkIn: "08:00 AM", checkOut: "02:00 PM" },
  { date: "2025-02-05", status: "absent", checkIn: "-", checkOut: "-" },
  { date: "2025-02-06", status: "present", checkIn: "07:50 AM", checkOut: "02:00 PM" },
  { date: "2025-02-07", status: "holiday", checkIn: "-", checkOut: "-" },
  { date: "2025-02-08", status: "present", checkIn: "08:00 AM", checkOut: "02:00 PM" },
  { date: "2025-02-09", status: "present", checkIn: "08:00 AM", checkOut: "02:00 PM" },
  { date: "2025-02-10", status: "present", checkIn: "08:00 AM", checkOut: "02:00 PM" },
];

const mockDuePayments: DuePayment[] = [
  { id: "1", month: "January", year: 2025, amount: 2500, dueDate: "2025-01-10", status: "paid", paidAmount: 2500, fine: 0 },
  { id: "2", month: "February", year: 2025, amount: 2500, dueDate: "2025-02-10", status: "partial", paidAmount: 1500, fine: 50 },
  { id: "3", month: "March", year: 2025, amount: 2500, dueDate: "2025-03-10", status: "unpaid", paidAmount: 0, fine: 0 },
  { id: "4", month: "April", year: 2025, amount: 2500, dueDate: "2025-04-10", status: "unpaid", paidAmount: 0, fine: 0 },
  { id: "5", month: "May", year: 2025, amount: 2500, dueDate: "2025-05-10", status: "unpaid", paidAmount: 0, fine: 0 },
];

const mockReports: Report[] = [
  { id: "1", title: "Half-Yearly Exam 2024", type: "exam", date: "2024-12-15", downloadUrl: "#" },
  { id: "2", title: "Monthly Progress Report - January", type: "progress", date: "2025-02-01", downloadUrl: "#" },
  { id: "3", title: "Attendance Summary - January", type: "attendance", date: "2025-02-01", downloadUrl: "#" },
  { id: "4", title: "Fee Payment History 2024", type: "fee", date: "2024-12-31", downloadUrl: "#" },
  { id: "5", title: "Annual Exam 2024", type: "exam", date: "2024-11-30", downloadUrl: "#" },
];
...
const DesktopSidebar = ({ studentData, activeTab, setActiveTab, sidebarOpen, setSidebarOpen }: any) => {
  return (
          ...
          return (
            ...
            >
              ...
              {sidebarOpen && item.id === "notifications" && (
                <Badge className="ml-auto bg-red-500 text-white border-0">3</Badge>
              )}
            </button>
          );
        })}
...
const MobileSidebar = ({ studentData, activeTab, setActiveTab, setMobileMenuOpen }: any) => {
  return (
          ...
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="font-medium text-gray-900">{studentData.nameBangla}</p>
              </div>
              <div>
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                ...
                <span className="font-bold text-purple-700">{studentData.id}</span>
              </div>
              <div className="flex justify-between items-center pb-2 border-b border-gray-100">
...
const AttendanceContent = ({ attendance, attendancePercentage, presentDays, absentDays, lateDays, totalDays, getStatusBadge }: any) => {
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <Card className="border-2 border-purple-100/50 shadow-lg">
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <Progress value={(presentDays / totalDays) * 100} className="h-2 bg-gray-100"  />
            
            <div className="flex justify-between text-sm">
              <span className="text-gray-600">Late</span>
              <span className="font-medium">{lateDays} days</span>
            </div>
            <Progress value={(lateDays / totalDays) * 100} className="h-2 bg-gray-100"  />
            
            <div className="flex justify-between text-sm">
              <span className="text-gray-600">Absent</span>
              <span className="font-medium">{absentDays} days</span>
            </div>
            <Progress value={(absentDays / totalDays) * 100} className="h-2 bg-gray-100" />
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border-2 border-purple-100/50 shadow-lg">
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>Your attendance records for February 2025</CardDescription>
          </div>
...
const DueContent = ({ duePayments, totalDue, totalPaid, totalUnpaid, duePercentage, getStatusBadge }: any) => {
  return (
    <div className="space-y-6 animate-fadeIn">
      <h2 className="text-2xl font-bold text-gray-900 flex items-center gap-2">
...
const ReportsContent = ({ reports }: { reports: Report[] }) => {
  const getReportIcon = (type: string) => {
    switch(type) {
      case "exam": return <Award className="text-purple-600" size={20} />;
      case "progress": return <TrendingUp className="text-green-600" size={20} />;
      case "attendance": return <CalendarDays className="text-blue-600" size={20} />;
      case "fee": return <Wallet className="text-amber-600" size={20} />;
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {reports.map((report) => (
          <Card key={report.id} className="border-2 border-purple-100/50 shadow-lg hover:shadow-xl transition-all group">
            <CardContent className="p-6">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Daily attendance notifications</p>
              </div>
              <Switch defaultChecked />
            </div>
            <Separator />
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500">Reminders for fee payments</p>
              </div>
              <Switch defaultChecked />
            </div>
          </CardContent>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                    <div>
                      ...
                      <p className="text-xs text-gray-500">Chrome • Windows • Dhaka</p>
                    </div>
...
const NotificationsContent = () => {
  const notifications = [
    { id: 1, title: "Fee Payment Reminder", message: "Your February fee payment is due in 3 days", time: "2 hours ago", type: "payment", read: false },
    { id: 2, title: "Attendance Alert", message: "You were marked absent on 05 Feb 2025", time: "Yesterday", type: "attendance", read: false },
    { id: 3, title: "Exam Schedule", message: "Half-yearly exam schedule has been published", time: "2 days ago", type: "exam", read: true },
    { id: 4, title: "Report Available", message: "Your January progress report is now available", time: "3 days ago", type: "report", read: true },
    { id: 5, title: "Class Rescheduled", message: "Mathematics class on Friday has been rescheduled", time: "5 days ago", type: "class", read: true },
  ];

  const getNotificationIcon = (type: string) => {
    switch(type) {
      case "payment": return <Wallet className="text-amber-600" size={20} />;
      case "attendance": return <CalendarDays className="text-blue-600" size={20} />;
      case "exam": return <Award className="text-purple-600" size={20} />;
      case "report": return <FileText className="text-green-600" size={20} />;
        ...
        <CardContent className="p-0">
          <div className="divide-y">
            {notifications.map((notification) => (
              <div key={notification.id} className={`p-4 hover:bg-gray-50 transition-colors flex items-start gap-4 ${!notification.read && 'bg-purple-50/50'}`}>
