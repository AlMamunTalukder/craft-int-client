    ...
    <div class="pdf-body">
      ...
      <div class="main-content">
        ...
        <div class="section">
          ...
          <div class="grid-2">
            <div class="info-card">
              <strong style="font-size:10px; color:#4c1d95;">পিতা: ${formData.FatherNameBangla || "-"}</strong>
              <div class="field mt-1"><span class="label">পেশা</span><div class="value" style="border:none; min-height:auto; font-size:10px;">${getProfessionDisplay(formData.FatherJob, 'father')}</div></div>
              <div class="field"><span class="label">মোবাইল</span><div class="value" style="border:none; min-height:auto; font-size:10px;">${formData.FatherMobile || "-"}</div></div>
              ${formData.FatherWhatsapp ? `<div class="field"><span class="label">হোয়াটসঅ্যাপ</span><div class="value" style="border:none; min-height:auto; font-size:10px;">${formData.FatherWhatsapp}</div></div>` : ""}
            </div>
            <div class="info-card">
              <strong style="font-size:10px; color:#4c1d95;">মাতা: ${formData.MotherNameBangla || "-"}</strong>
              <div class="field mt-1"><span class="label">পেশা</span><div class="value" style="border:none; min-height:auto; font-size:10px;">${getProfessionDisplay(formData.MotherJob, 'mother')}</div></div>
              <div class="field"><span class="label">মোবাইল</span><div class="value" style="border:none; min-height:auto; font-size:10px;">${formData.MotherMobile || "-"}</div></div>
              ${formData.MotherWhatsapp ? `<div class="field"><span class="label">হোয়াটসঅ্যাপ</span><div class="value" style="border:none; min-height:auto; font-size:10px;">${formData.MotherWhatsapp}</div></div>` : ""}
            </div>
          </div>
          ${(formData.guardianNameBangla || formData.guardianName) ? `
          <div class="info-card mt-1">
            <strong style="font-size:10px; color:#4c1d95;">অভিভাবক: ${formData.guardianNameBangla || formData.guardianName || "-"}</strong>
            <div class="flex-between mt-1">
              <span style="font-size:9px;">সম্পর্ক: ${formData.guardianRelation || "-"}</span>
              <span style="font-size:9px;">মোবাইল: ${formData.guardianMobile || "-"}</span>
            </div>
        ...
        <div style="text-align: center; margin-top: 8px; font-size: 7px; color: #94a3b8;">
